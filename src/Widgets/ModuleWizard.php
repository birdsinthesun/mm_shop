<?php
namespace Bits\FlyUxBundle\Widgets;
...
class ModuleWizard extends Widget
{
	...
	public function generate()
	{
		...
		$modules[] = array('id'=>0, 'name'=>$GLOBALS['TL_LANG']['MOD']['content'][0], 'type'=>'content');
		...
		$GLOBALS['TL_LANG']['FMD']['content'] = $GLOBALS['TL_LANG']['MOD']['content'];
